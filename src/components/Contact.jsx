...
const Contact = () => {
  ...
  return (
    <div className="">
      <div className="mb-6">
        <img
          src="https://c0.wallpaperflare.com/preview/951/60/55/business-city-communication-connection.jpg"
          alt="contact"
        />
      </div>
      <div className="px-4">
        ...
        <div className="bg-green-600 rounded-full p-2 fixedD hidden bottom-[15%] right-2 hover:opacity-80 hover:scale-95">
